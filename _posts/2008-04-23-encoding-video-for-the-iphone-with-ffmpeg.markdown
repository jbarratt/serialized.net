...
<p>I wanted to convert pretty much any kind of video to iphone format.  This was for 2 reasons:
...
<code>sudo port install ffmpeg +gpl +lame +x264 +xvid +faac +faad +a52</code>

I found a problem with this, where it errored out saying something like:

<p>@: make -C libpostproc install-headers
